...
jQuery( function( $ ) {
	...
	var wc_checkout_form = {
		...
		payment_method_selected: function() {
			if ( $( '.payment_methods li' ).length > 1 ) {
		...
		update_checkout_action: function() {
			...
			var payment_method = $( '#customer_details' ).find( 'input[name=payment_method]:checked' ).val(),
		...
		submit: function() {
			...
			if ( $form.triggerHandler( 'checkout_place_order' ) !== false && $form.triggerHandler( 'checkout_place_order_' + $( '#customer_details' ).find( 'input[name=payment_method]:checked' ).val() ) !== false ) {
